        ...
        <div className="hidden sm:flex items-center space-x-2 sm:space-x-3">
          ...
          {isSpeaking && (
            <button
              ...
              className="flex items-center space-x-1.5 px-3 py-1.5 rounded-md text-xs font-semibold bg-rose-600 hover:bg-rose-700 text-white animate-pulse transition"
          ...
          <button
            ...
            className={`flex items-center space-x-1.5 px-3 py-1.5 rounded-md text-xs font-semibold transition border ${
              isListening
                ? "bg-rose-600 border-rose-500 text-white animate-bounce shadow-lg shadow-rose-900/50"
                : "bg-navy-800/90 border-navy-700 text-slate-200 hover:bg-navy-700 hover:border-slate-500"
            }`}
          ...
          <button
            ...
            className="flex items-center space-x-1.5 px-3 py-1.5 rounded-md text-xs font-semibold bg-navy-800/90 border border-navy-700 text-slate-200 hover:bg-navy-700 transition"
          ...
          {isOfficer ? (
            <div className="flex items-center space-x-2">
              <span className="hidden md:inline-block px-2.5 py-1 rounded bg-amber-500/20 text-amber-300 border border-amber-500/30 text-[11px] font-semibold">
                Officer: {officer?.name || "Priya Sharma"}
              </span>
              <button
                onClick={logoutOfficer}
                className="flex items-center space-x-1.5 px-3 py-1.5 rounded-md text-xs font-semibold bg-slate-800 hover:bg-slate-700 border border-slate-600 text-slate-200 transition"
              >
